...
let museumExperianceTwo = new Experience(
  2,
  "Culture",
  "Museum",
...
let museumExperianceThree = new Experience(
  3,
  "Culture",
  "Museum",
...
let theaterExperianceOne = new Experience(
  4,
  "Culture",
  "Theater",
...
let theaterExperianceTwo = new Experience(
  5,
  "Culture",
  "Theater",
  "./assets/experiences/5.oscarsteatern.jpg",
  "Föreställning på OscarsTeater",
  "Decription",
  350
);
let theaterExperianceThree = new Experience(
  6,
  "Culture",
  "Theater",
...
let musicExperianceOne = new Experience(
  7,
  "Culture",
  "Music",
...
let musicExperianceTwo = new Experience(
  8,
  "Culture",
  "Music",
...
let musicExperianceThree = new Experience(
  9,
  "Culture",
  "Music",
...
let dinnerExperianceOne = new Experience(
  10,
  "Food Experiences",
  "Dinner",
  "./assets/experiences/10.indiskmat.jpg",
  "Indisk trerätters middag inkl. ett glas öl eller vin",
  "Description",
  450
);
let dinnerExperianceTwo = new Experience(
  11,
  "Food Experiences",
  "Dinner",
...
let dinnerExperianceThree = new Experience(
  12,
  "Food Experiences",
  "Dinner",
...
let alcoholExperianceOne = new Experience(
  16,
  "Food Experiences",
  "Alcohol",
...
let alcoholExperianceTwo = new Experience(
  17,
  "Food Experiences",
  "Alcohol",
...
let alcoholExperianceThree = new Experience(
  18,
  "Food Experiences",
  "Alcohol",
...
listOfExperience.push(
  museumExperianceOne,
  museumExperianceTwo,
  museumExperianceThree,
  theaterExperianceOne,
  theaterExperianceTwo,
  theaterExperianceThree,
  musicExperianceOne,
  musicExperianceTwo,
  musicExperianceThree,
  dinnerExperianceOne,
  dinnerExperianceTwo,
  dinnerExperianceThree,
  afternoonTeaExperianceOne,
  afternoonTeaExperianceTwo,
  afternoonTeaExperianceThree,
  alcoholExperianceOne,
  alcoholExperianceTwo,
  alcoholExperianceThree,
  outsideExperianceOne,
  outsideExperianceTwo,
  outsideExperianceThree,
  indoorExperianceOne,
  indoorExperianceTwo,
  indoorExperianceThree,
  familyExperianceOne,
  familyExperianceTwo,
  familyExperianceThree,
  facialExperianceOne,
  facialExperianceTwo,
  facialExperianceThree,
  massageExperianceOne,
  massageExperianceTwo,
  massageExperianceThree,
  relaxationExperianceOne,
